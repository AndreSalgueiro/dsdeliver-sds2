...
function OrderDetails({route}: Props) {
  ...
  const navigation = useNavigation();
    ...
    const handleConfirmDelivery = () => {
        ...
        .then(() => {
            Alert.alert(`Pedido ${order.id} conformado com sucesso!`);
            navigation.navigate('Orders');
        })
        .catch(() => {
    ...
    const handdleStartNavegation = () =>{
        //integração com app google maps
  ...
  return (
   ...
   <View style={styles.container}>
        ...
        <RectButton style={styles.button} onPress={handdleStartNavegation}>
